...
This code was cloned from [thtrieu repository](https://github.com/thtrieu/darkflow). I adopted the code for new tensorflow version and implemented some improvements. 
...
Python3, tensorflow 1.14.0, numpy, opencv 4.
